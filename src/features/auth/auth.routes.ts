...
router.post('/auth/login', loginValidate, async (req: Request, res: Response, next: NextFunction) =>
...
router.post('/auth/refresh', async (req: Request, res: Response, next: NextFucntion) =>
